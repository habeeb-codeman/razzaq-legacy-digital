...
const MAP_DIRECT_LINK = "https://www.google.com/maps/dir/?api=1&destination=16.5087592,80.6480903";
...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-card/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-12 mb-16">
          ...
          >
            <motion.div 
              ...
              whileHover={{ 
                boxShadow: "0 0 40px hsl(177 100% 33% / 0.15)",
          ...
          >
            {contactDetails.map((detail, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <motion.div 
                    className="flex items-center justify-center w-12 h-12 bg-gradient-primary rounded-lg flex-shrink-0"
            ...
            <div className="inline-flex items-center justify-center gap-4 flex-wrap">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  aria-label="Visit Razzaq Automotives location (opens in maps)"
        ...
        <ScrollReveal direction="fade" delay={0.5}>
          ...
          >
            ...
            >
              <MapPin className="w-4 h-4" />
              <p className="text-lg">
                Razzaq Automotives, 3rd Cross Road, Auto Nagar, Vijayawada, Andhra Pradesh 520007
              </p>
            </motion.div>
          </motion.div>
        </ScrollReveal>
        ...
        <ScrollReveal direction="scale" delay={0.6}>
          <motion.div
            className="glass-card overflow-hidden p-0"
            whileHover={{ 
              boxShadow: "0 0 50px hsl(177 100% 33% / 0.2)",
              transition: { duration: 0.3 }
            }}
          >
            <div className="h-96 w-full">
