      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Button onClick={() => handleNavClick('contact', false)} variant="default" className="btn-hero">
              Get Quote
            </Button>
          </div>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col space-y-4 pt-4">
              ...
              <Button onClick={() => handleNavClick('contact', false)} className="btn-hero mx-4 mt-2">
                Get Quote
              </Button>
            </div>
          </motion.div>
